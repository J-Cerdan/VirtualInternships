...
function isValidName(name) {
  ...
  $('.checkout-button').click(function() {
    ...
    if (getQuantityStrawberriesCream==0 && getQuantityCoconutMango==0 && getQuantitySaltedCaramel==0){
        alert('You forgot to select your ice cream scoops!');
        return;
    }
    ...
    let messageText = 'Thank you for ordering ' + getName + '! \nYou have ordered a ' + getIcecreamType + 
    ' with ' + getQuantityCoconutMango + ' Coconut Mango, ' + getQuantitySaltedCaramel + ' Salted Caramel and ' + getQuantityStrawberriesCream + ' Strawberries and Cream' +
    '!\nYour total order cost is: $' + total.toFixed(2) + '. Thank you, come again soon! :)';
